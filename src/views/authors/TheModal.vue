...
async function submit() {
  ...
  postPutAuthor(data.formInfo, image).then((res) => {
  ...
  <Modal v-if="data.display">
    <div class="flex items-center h-full">
      ...
      <div class="flex flex-col my-3.5">
        ...
        <input type="text" pattern="[A-Za-z0-9_-]+" v-model="data.formInfo.username" class="input" placeholder="Foydalanuvchi nomi" required>
        <input type="password" v-model="data.formInfo.password" class="input" placeholder="Parol" required>
        </div>
