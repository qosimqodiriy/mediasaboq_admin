...
<div class="main bg-gray-primary px-8 md:px-12 lg:px-20 right-0 fixed top-0 bottom-0 overflow-y-scroll">
  <div class="flex justify-between h-28 items-center">
    ...
    <div class="flex items-center">
      ...
      <router-link :to="{path: '/media'}" class="bg-orange-primary shadow-lg shadow-black-primary-500/50 items-center text-white-primary flex px-5.5 py-3 rounded" role="button">
